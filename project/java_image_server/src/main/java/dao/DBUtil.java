...
import java.sql.PreparedStatement;//继承自statement接口，sql语句被编译存储在这里面
import java.sql.ResultSet;//存放数据库里取出的结果集的对象
import java.sql.SQLException;
//1、加载jdbc驱动
//2、建立数据库连接Connection conn=Driver.getConnection()
//3、创建Statement,用来执行sql语句 4、关闭结果集
public class DBUtil {
